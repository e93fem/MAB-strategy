...
public class TestChunkHandler {
    ...
    public void testChunkHandler() {
        ...
        Chunk expectChunk1 = new Chunk(0, 2, 0, 2);
        chunkHandler.addChunk(expectChunk1);
        Chunk expectChunk2 = new Chunk(2, Integer.MAX_VALUE, 0, 2);
        chunkHandler.addChunk(expectChunk2);
        Chunk expectChunk3 = new Chunk(2, Integer.MAX_VALUE, 2, Integer.MAX_VALUE);
